...
SECRET_KEY = 'django-insecure-54tba^on5cun^h5kzs37f=ttpme50l75cut1x@6o7&lk3cjsi#'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://localhost:6379/1',  # Use localhost when running Django outside Docker
        'OPTIONS': {
