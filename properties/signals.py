...
def invalidate_properties_cache_on_save(sender, instance, **kwargs):
    ...
    print(f"Cache 'all_properties' cleared after Property {instance.title} was saved.")
...
def invalidate_properties_cache_on_delete(sender, instance, **kwargs):
    ...
    """
    cache.delete('all_properties')
    print(f"Cache 'all_properties' cleared after Property {instance.title} was deleted.")
